...
export const makeMarkMat = (): THREE.ShaderMaterial =>
  makeQuadMat(MARK_FRAG, { uLeft: { value: 1 }, uGain: { value: 1 } });
...
type ShapeKind = "lanes" | "props" | "cells" | "set" | "burrow";
...
export class BossFx {
  ...
  private static readonly EXPOSURE_FLOOR = 0.45;
  /**
