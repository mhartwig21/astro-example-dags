...
//                   battle linger: a mid-fight fetch stall on a phone
...
//                   crossfade-trim (two beats at the track's ~100 BPM).
//
...
// must be named explicitly — there is no "run everything" default.
//
